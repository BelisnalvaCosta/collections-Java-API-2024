...
public class ListaTarefa {
    ...
    public static void main(String[] args) {
        ...
        listaTarefa.adicionarTarefa("Ir ao mercado fazer as Compras");
        listaTarefa.adicionarTarefa("Ir ao Dentista");
        listaTarefa.adicionarTarefa("Pesquisar e Estudar");
        listaTarefa.adicionarTarefa("Fazer exercícios");
        listaTarefa.adicionarTarefa("Ir ao Parquinho com as crianças");
        listaTarefa.adicionarTarefa("Caminhar e fazer alongamentos");
        ...
        listaTarefa.removerTarefa("Caminhar e fazer alongamentos");
        ...
        listaTarefa.removerTarefa("Ir ao Dentista");
