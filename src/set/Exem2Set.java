...
*/
public class Exem2Set {
    public static void main(String[] args) {
        Set<LinguagemFavorita> minhasLinguagensFavoritas = new HashSet<>();
        minhasLinguagensFavoritas.add(new LinguagemFavorita("Python", 1990, "Pycharm"));
        minhasLinguagensFavoritas.add(new LinguagemFavorita("JavaScript", 1997, "IntelliJ"));
        minhasLinguagensFavoritas.add(new LinguagemFavorita("Java", 1990, "Visual Studio Code"));

        System.out.println("--------\tOrdem de Inserção\t--------");
        Set<LinguagemFavorita> minhasLinguagensFavoritas1 = new LinkedHashSet<>(
                Arrays.asList(
                        new LinguagemFavorita("Python", 1990, "Pycharm"),
                        new LinguagemFavorita("JavaScript", 1997, "IntelliJ"),
                        new LinguagemFavorita("Java", 1990, "Visual Studio Code")
                )
        );
